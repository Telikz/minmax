      ...
      <main className="flex-col">
        <div class="hero bg-base-100">
          ...
          <div className="grid col-auto gap-4">
            <Link href='/Meditation/GettingStarted' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
            ...
            <Link href='/Meditation/learnMeditation' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
              <div class="card-body items-center">
            ...
            </Link><Link href='/Meditation/learnMeditation' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
              <div class="card-body items-center">
