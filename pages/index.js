        ...
        <div className='flex flex-col'>
          ...
          <div className='container mx-auto p-4'>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Link href='/Meditation' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
              ...
              <Link href='/Yoga' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
                <div class="card-body items-center">
              ...
              </Link><Link href='/Fitness' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
                <div class="card-body items-center">
              ...
              </Link><Link href='/Nutrition' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
                <div class="card-body items-center">
              ...
              </Link><Link href='/Communication' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
                <div class="card-body items-center">
              ...
              </Link><Link href='/Streangth' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
                <div class="card-body items-center">
              ...
              </Link><Link href='/Sleep' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
                <div class="card-body items-center">
              ...
              </Link><Link href='/Cheats' class="card bg-base-100 shadow-xl image-full hover:bg-base-200">
                <div class="card-body items-center">
